...
class HTMLRendererMixin(object):
    ...
    def link(self, link, title, content):
        ...
        rv = template.render(href=src, text=content, title=title, embed=embed, site=self.site)
        rv = rv.encode('utf-8')
        return rv
    ...
    def image(self, src, title, alt_text):
        ...
        rv = template.render(src=src, alt=alt_text, title=title, plugin_data=self.plugin_data, site=self.site)
        rv = rv.encode('utf-8')
        return rv
    ...
    def header(self, text, level, raw=None):
        ...
        rv = template.render(level=level, text=text, id=self.toc_count, site=self.site)
        rv = rv.encode('utf-8')
    ...
    def block_quote(self, text):
        ...
        rv = template.render(text=text, site=self.site)
        rv = rv.encode('utf-8')
        return rv
    ...
    def init(self, jinja2, code_formatter, plugin_data, site):
        ...
        Args:
            ...
            plugin_data (dict): data generated by preprocess plugins that are needed at parsing time
